      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            Welcome to <span className="text-blue-600">FinanceFlow</span>
          </h1>

          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Your comprehensive accounting solution for managing journal entries, ledgers, and financial reports with
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Record and manage your financial transactions with ease</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Generate comprehensive reports and trial balances</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Ledger Management</h3>
              <p className="text-gray-600">Track account balances and transaction history</p>
            </div>
          </div>
        </div>
      </div>
